...
class AddIncomeBts extends StatelessWidget {
  final VoidCallback onIncomeAdded;
  BuildContext rootContext;

   AddIncomeBts({super.key,required this.onIncomeAdded,required this.rootContext});
      ...
      child: BlocListener<ButtonCubit, ButtonState>(
        listener: (context, state) async {
          if (state is ButtonSuccessState) {
            context.flushBarSuccessMessage(message: 'Income saved successfully');
            onIncomeAdded();
